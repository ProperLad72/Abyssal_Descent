...
{
    [SerializeField] private string secondFloorSceneName = "Thirdfloor";  // Set this to your actual scene name in the Inspector
    ...
    private IEnumerator TransitionToNewScene()
    {
        ...
        else
        {
            ...
            SceneManager.UnloadSceneAsync("Secondfloor");
        }
    }
}